@echo off
set /p save=<swordoffire.save
title The Sword of Fire DEVELOPER COPY
:titlescreen
echo The Sword of Fire, written by Knucklesfan
echo WARNING: This game uses your computer clock to determine things such as time in game.
@rem A little warning, if you are a programmer, viewing this build, please avoid messing with %tempadd% during battle sequences. 
@rem You are right now using a developer copy, and most of the things in here will most likely be cleaned up before release.
echo Enter Name
set /p name=
set pick=7
...
echo Load save or start new game?
echo CHOOSE:
echo 1.New Game
echo 2.Load Game
set /p chsc=choice1~2
if %chsc%==1 echo start>swordoffire.save
if %chsc%==2 goto %save%
pause
goto start
:start
...
pause >nul
echo LEVEL SELECT
echo if you are getting here in the final game, that means that I messed up somewhere.
echo 1. Play the game normally
echo 2. Chapter 0 Midway
echo 3. Chapter 0 Midway Guard Option
echo 4. Chapter 0 Midway Give up option
echo 5. Chapter 1 Attack option
echo 6. Chapter 1 Flee option
echo 7. Chapter 1 Midway
echo 8-20. Empty slots
echo Select a level
set /p levelselect=choice1~20
if %levelselect%==1 timeout 0 >nul
if %levelselect%==2 goto cont1
if %levelselect%==3 goto guard
if %levelselect%==4 goto give
if %levelselect%==5 goto attack1
if %levelselect%==6 set flee
if %levelselect%==7 goto newcp
if %levelselect%==8 goto unused
if %levelselect%==9 goto unused
if %levelselect%==10 goto unused
if %levelselect%==11 goto unused
if %levelselect%==12 goto unused
if %levelselect%==11 goto unused
if %levelselect%==12 goto unused
if %levelselect%==13 goto unused
if %levelselect%==14 goto unused
if %levelselect%==15 goto unused
if %levelselect%==16 goto unused
if %levelselect%==17 goto unused
if %levelselect%==18 goto unused
if %levelselect%==19 goto unused
if %levelselect%==20 goto unused
cls
...
timeout %spd%
cls
echo You are clueless to what he is talking about. Has somebody stolen your identity?
timeout %spd%
cls
echo CHOOSE:
echo 1. Fight Guard
...
if %end2%==1 goto savechap1
if %end2%==2 goto chap1
:savechap1
del swordoffire.save
echo chap1>swordoffire.save
goto chap1
:chap1
cls
...
:mainmenu1
cls
if %enemyhealth% LEQ 0 goto battlecomplete
...
goto titlescreen
:battlecomplete
set /a tempadd=%exp%+%enemyxp%
set /a exp=%tempadd%
echo You won! You gained %enemyxp% and now have %exp%
...
echo Checkpoint!
set cpoint=newcp
echo You look down. After killing the 3 men, you notice that something is missing.
timeout %spd%
cls
echo [You] Oh god! Oh god! Oh god! Where is he?
timeout %spd%
cls
echo You look around. The body is nowhere to be seen.
timeout %spd%
cls
echo [You] Oh god! There's a drunken man on the loose!
timeout %spd%
cls
echo You decide to run back to the bar to check if he was there.
timeout %spd%
cls
echo [Man] Look sir we're closed and-
timeout %spd%
cls
echo [You] Have you seen him?
timeout %spd%
cls
echo [Man] Who?
timeout %spd%
cls
echo [You] The drunken man I was carrying around?
timeout %spd%
cls
echo [Man] I'm sorry, I haven't seen him since you left the bar.
timeout %spd%
cls
echo You run out of the bar, and go back to the bridge.
timeout %spd%
cls
echo For some odd reason, you have the strange urge to look down. Then you notice your fate...
timeout %spd%
cls
goto dead1
:dead1
echo You slowly notice that...
timeout 2 >nul
echo that...
timeout 2 >nul
echo that the man that you saw...
timeout 2 >nul
echo IS DEAD!!!
timeout %spd%
cls
...
timeout %spd%
cls
echo You step back in shock. The man is impaled by a fallen sword stuck in the mud below the bridge. The sword is covered in blood.
timeout %spd%
cls
echo [You] Dear god. Oh god.
timeout %spd%
cls
echo You look down. At the sword. It is a very fancy sword.
timeout %spd%
cls
echo CHOOSE:
echo 1. Take the sword
echo 2. Run back to the bar to tell that you found the man
set /p fin=choice1~2
if %fin%==1 goto takesword
if %fin%==2 goto bran1
:takesword
cls
echo You decide to slide down into the area where the man is impaled. Upon further investigation, the sword wound was self-inflicted.
timeout %spd%
cls
echo You sheive the sword. It's dripping with blood, but you think it says "Sword of Sin" on it's handle.
timeout %spd%
cls
echo NEW ITEM: Sword of Sin! 
echo Attack: 100 
echo SPECIAL POWER: Use your sins against your enemies! The more you use the weapon, the more damage the sword does!
echo Equip it now?
echo CHOOSE:
echo 1. Equip sword
echo 2. Leave sword behind
set /p fin=choice1~2
if %fin%==1 goto equipswordofsin
if %fin%==2 goto bran1
:equipswordofsin
echo You decide to equip the sword of sin.
set attack=100
timeout %spd%
cls
echo You jump out of the pit where the sword was. There still is blood dripping from the blade as you jump out.
timeout %spd%
cls
echo [You] Ew! Disgusting!
timeout %spd%
cls
echo You, luckily, carry around with yourself a cleansing tissue. You wipe the sword clean.
timeout %spd%
cls
echo You now see a message inscribed in the blade: "Property of Swishem Burgerison the third, King of March Island"
timeout %spd%
cls
echo You just stole the kings blade.
timeout 2 >nul
echo And the sad thing is...
timeout 2 >nul
echo You don't feel a bit guilty.
timeout %spd%
echo You run for your life. As you see the man come along and see the dead body. He screams at you.
timeout %spd%
cls
echo I WILL GET YOU SOME DAY YOU LITTLE-
timeout %spd%
cls
echo But you were too far to hear the rest.
timeout %spd%
cls
echo You keep running faster. You don't know where your going and you don't know when you'll get there. You keep on running until your legs get sore, and then, you fall down.
goto endchapter2
:bran1
echo You decide to run over to the bar tender, and inform him about the death.
timeout %spd%
cls
echo [You] Sir! Sir! A man has just died out infront of your bar!
timeout %spd%
cls
echo [Man] What?! Let me see this.
timeout %spd%
cls
echo You and the man walk out to the bridge. When the man sees it, he screams out in fear.
timeout %spd%
cls
echo [Man] Do you take this as some kind of sick joke?
timeout %spd%
cls
echo [You] What?
timeout %spd%
cls
echo [Man] Killing a man, and then, showing me the dead body! I will not accept this. I'm calling the police.
timeout %spd%
cls
echo [You] But.. But, I didn't do it!
timeout %spd%
cls
echo You begin running. You don't know where you're going, and you don't know when you'll get there. You keep on running until your legs get sore, and then, you fall down.
timeout %spd%
cls
set souls=0
goto endchapter2
...
echo END OF CHAPTER!
echo STATS:
echo Health: %hp% - Upgradable.
echo Level: %lvl% - Not upgradable.
echo Hunger: %hunger% - Not upgradable.
echo Armor: %armor% - Not upgradable.
echo Upgrade all upgradable stats?
echo 1.Yes
echo 2.No
set /p end1=choice1~2
if %end1%==1 set hp=500
if %end1%==2 goto next2
:next2
echo Save?
echo 1.Yes
echo 2.No
set /p end2=choice1~2
if %end2%==1 goto savechap2
if %end2%==2 goto chap2
:savechap2
del swordoffire.save
echo chap2>swordoffire.save
:chap2
echo I am not finished yet!
timeout %spd%
cls
:gameover
...
echo WARNING! Save feature is not completed yet. Please remember that if you quit now, you cannot restore from the last checkpoint.
echo CHOOSE:
