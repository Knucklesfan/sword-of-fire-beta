...
timeout
echo CHOOSE:
echo 1. Run to the bar
echo 2. Run back to March Island
set /p run=choice1~2
if %run%==1 goto bar
if %run%==2 goto run
:bar
...
echo 1. Look down
echo 2. Run back to March Island
set /p find=choice1~2
if %find%==1 goto look
if %find%==2 goto marchislandrun
:look
cls
...
timeout %spd%
cls
echo You jsut stole the kings blade.
timeout 2 >nul
